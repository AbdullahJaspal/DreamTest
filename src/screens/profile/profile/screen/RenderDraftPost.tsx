...
import LineraGradients from 'react-native-linear-gradient';
import {formatNumber} from '../../../../utils/formatNumber';
import {icons} from '../../../../assets/icons';

const {width, height} = Dimensions.get('window');

interface RenderDraftPostProps {
  item: any;
  index: number;
  onPostClick: (index: number) => void;
}

const RenderDraftPost: React.FC<RenderDraftPostProps> = ({
  item,
  index,
  onPostClick,
}) => {
...
export default RenderDraftPost;
